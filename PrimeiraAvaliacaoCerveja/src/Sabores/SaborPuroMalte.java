...
public class SaborPuroMalte extends Cerveja implements Cervejaria {

	public SaborPuroMalte() {
		super();
	}

	public SaborPuroMalte(String codigo, String sabor, String dataProducao, String dataValidade, double preco) {
